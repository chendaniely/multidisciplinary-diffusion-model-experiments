...
cat("![networkx generated network](/home/dchen/git/multidisciplinary-diffusion-models-experiments/experiments/output/mann-generated.png)")
```

# my copied graph

```{r, echo=FALSE, comment="", results='asis'}
cat("![networkx generated network](/home/dchen/git/multidisciplinary-diffusion-models-experiments/experiments/output/mann-copied.png)")
```


```{r, echo=FALSE}
df <- read.csv("network_of_agents.pout", header=FALSE)
...
df2 <- df %>%
  ...
  summarize(pos = mean(agent_avg_pos),
